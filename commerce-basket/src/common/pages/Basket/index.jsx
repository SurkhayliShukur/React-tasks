...
import DeleteSingle from "../../components/Modal/DeleteSingle";
...
const Basket = (props) => {
  ...
  return (
    <>
      ...
      <DeleteAll
        isRemoveAllModalOpen={isRemoveAllModalOpen}
        setIsRemoveAllModalOpen={setIsRemoveAllModalOpen}
